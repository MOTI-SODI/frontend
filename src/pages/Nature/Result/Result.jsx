      ...
      <div className={styles.form}>
        ...
        <div className={styles.middleBar}>
          <div className={styles.emotionality}>
            <button className={styles.emotionalityCircle} onClick={() => setIsEmotionalityOpen(true)}>감정성</button>
          ...
          <div className={styles.extraversion}>
            <button className={styles.extraversionCircle} onClick={() => setIsExtraversionOpen(true)}>외향성</button>
          ...
          <div className={styles.agreeableness}>
            <button className={styles.agreeablenessCircle} onClick={() => setIsAgreeablenessOpen(true)}>우호성</button>
          ...
          <div className={styles.honesty}>
            <button className={styles.honestyCircle} onClick={() => setIsHonestyOpen(true)}>진솔성</button>
          ...
          <div className={styles.conscientiousness}>
            <button className={styles.conscientiousnessCircle} onClick={() => setIsConscientiousnessOpen(true)}>신중성</button>
          ...
          <div className={styles.open}>
            <button className={styles.openCircle} onClick={() => setIsOpenOpen(true)}>개방성</button>
